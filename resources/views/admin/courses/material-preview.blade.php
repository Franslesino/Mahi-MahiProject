                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-4 mt-3 text-sm text-gray-500">
                                        ...
                                        @endif
                                        <span
                                            class="px-2 py-1 rounded {{ $material->status === 'published' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700' }}">
                            ...
                            @elseif($material->type === 'text')
                                ...
                                <div class="prose max-w-none">
                                    @if($material->content || $material->isi)
                                        @php
                                            $textContent = $material->content ?? $material->isi;
                                        ...
                                        @if(count($uniqueUrls) > 0)
                                            <div style="margin-top: 1.5rem;">
                                                <p style="font-weight: 600; color: #404040; margin-bottom: 0.75rem;">
                                    ...
                                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-yellow-700">Quiz ini belum memiliki assignment. Buat ulang lewat
                                                    halaman kursus.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4">
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                            ...
                                            <div class="p-4 bg-green-50 rounded-lg border border-green-100">
                                                ...
                                                <p class="text-xl font-bold text-green-900">{{ $assignment->passing_score ?? 0 }}%
                                                </p>
                                            </div>
                                        ...
                                        @else
                                            <div class="border border-gray-200 rounded-lg">
                                                <div class="flex items-center justify-between px-4 py-3 bg-gray-50 border-b">
                                                    ...
                                                    <a href="{{ route('admin.assignments.edit-questions', $assignment) }}"
                                                    ...
                                                    @foreach($assignment->questions as $idx => $question)
                                                        <div class="px-4 py-3">
                                                            <div class="flex items-start gap-2">
                                                                <span
                                                                    class="px-2 py-1 text-xs bg-gray-100 text-gray-700 rounded">#{{ $idx + 1 }}</span>
                                                                <div class="flex-1">
                                                                    <div class="flex items-center gap-2 text-xs text-gray-500 mb-1">
                                                                        <span
                                                                            class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded">{{ ucfirst(str_replace('_', ' ', $question->type)) }}</span>
                                                                        <span
                                                                            class="px-2 py-0.5 bg-green-100 text-green-700 rounded">{{ $question->pivot->points ?? $question->points }}
                                                                            poin</span>
                                                                    </div>
                        ...
                        <div class="p-6 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
                            @if($prevMaterial)
                                <a href="{{ route('admin.courses.materials.preview', [$course, $prevMaterial]) }}"
                            ...
                            @if($nextMaterial)
                                <a href="{{ route('admin.courses.materials.preview', [$course, $nextMaterial]) }}"
                                ...
                                <a href="{{ route('admin.courses.materials.preview', [$course, $mat]) }}"
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p
                                                class="font-medium text-sm text-gray-900 truncate {{ $mat->id === $material->id ? 'text-blue-600' : '' }}">
                                                {{ $mat->judul }}
                                            </p>
