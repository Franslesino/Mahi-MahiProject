            ...
            @else
                <div class="bg-red-50 border-l-4 border-red-400 p-6 rounded-lg">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-bold text-red-900 mb-2">Transaksi {{ ucfirst($transaction->status) }}</h3>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                        ...
                        <div>
                            <div class="font-bold text-gray-900">{{ ucwords(str_replace('_', ' ', $transaction->payment_method)) }}</div>
                    ...
                    @if($transaction->isPending() && !$transaction->isExpired())
                        ...
                        <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex items-start gap-3 mb-3">
                                <img src="{{ asset('bni.png') }}" alt="BNI" class="h-8 mt-1"

                                     alt="Bank BNI" 
                                     class="h-8 mt-1">
                                <div class="flex-1">
                                    <h4 class="font-bold text-gray-900 mb-1">Transfer ke Rekening BNI:</h4>
                                    <div class="bg-white p-3 rounded border border-blue-300 flex items-center justify-between">
                                        <div>
                                            <div class="text-xs text-gray-600 mb-1">Nomor Rekening</div>
                                            <div class="text-xl font-bold text-gray-900 tracking-wider" id="rekening-number">
                                                7189828574 1034
                                            </div>
                                            <div class="text-sm text-gray-700 mt-1">a.n. <strong>Politeknik Negri Jakarta</strong></div>
                                        </div>
                        ...
                        <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <ol class="list-decimal list-inside space-y-2 text-sm text-gray-700">
                                ...
                                <li>Masukkan nominal: <strong>Rp {{ number_format($transaction->total_bayar, 0, ',', '.') }}</strong></li>
                        ...
                        <form action="{{ route('transactions.confirm', $transaction) }}" method="POST" class="mt-4">
                            @csrf
                            <button type="submit" 
