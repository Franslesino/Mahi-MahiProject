                ...
                <div class="page-header animate-in">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="page-subtitle"><?php echo e($kursus->judul); ?></p>
                        </div>
                        <a href="<?php echo e(route('student.course.learn', $kursus->id)); ?>" class="btn-modern btn-secondary-modern">
                ...
                <div class="hero-card animate-in animate-delay-2">
                    <div class="hero-content">
                        <h2 class="hero-title">
                            ...
                            <?php echo e($finalQuiz->judul_quiz); ?>

                        </h2>
                        <p class="hero-subtitle">Final Quiz untuk kursus <?php echo e($kursus->judul); ?></p>
                        
                        <div class="stats-grid">
                            <div class="stat-box">
                                <div class="stat-label">Nilai Minimum</div>
                                <div class="stat-value"><?php echo e($kursus->min_passing_score); ?>%</div>
                            </div>
                            <div class="stat-box">
                                <div class="stat-label">Maks. Percobaan</div>
                                <div class="stat-value"><?php echo e($kursus->max_quiz_attempts); ?>x</div>
                            </div>
                            <div class="stat-box">
                                <div class="stat-label">Durasi</div>
                                <div class="stat-value"><?php echo e($finalQuiz->durasi_quiz ?? '∞'); ?> min</div>
                            </div>
                            <div class="stat-box">
                        ...
                        <div class="card-body-modern">
                            <?php if($hasPassed): ?>
                                <div style="text-align: center; padding: 2rem 0;">
                                    ...
                                    <h3 style="color: var(--success); font-weight: 700; margin-bottom: 0.5rem;">Selamat! Anda Telah Lulus!</h3>
                                    <p style="color: var(--neutral-600); font-size: 1.125rem; margin-bottom: 2rem;">
                                        Nilai terakhir: <strong style="font-family: 'Space Mono', monospace; color: var(--success);"><?php echo e(number_format($latestAttempt->score, 2)); ?>%</strong>
                                    </p>
                                    <a href="<?php echo e(route('courses.show', $kursus->id)); ?>" class="btn-modern btn-success-modern">
                            ...
                            <?php elseif($canRetake): ?>
                                <div style="margin-bottom: 2rem;">
                                    <h3 style="font-weight: 700; color: var(--neutral-900); margin-bottom: 0.75rem;">
                                        <?php echo e($attemptCount > 0 ? 'Coba Lagi' : 'Mulai Final Quiz'); ?>

                                    </h3>
                                    <p style="color: var(--neutral-600); margin-bottom: 0;">
                                        Percobaan: <strong style="color: var(--primary);"><?php echo e($attemptCount); ?></strong> / <strong><?php echo e($kursus->max_quiz_attempts); ?></strong>
                                    </p>
                                </div>
                                
                                <button type="button" class="btn-modern btn-primary-modern" onclick="openStartConfirm(this)" style="width: 100%; justify-content: center; padding: 1.25rem;">
                            ...
                            <?php else: ?>
                                <div style="text-align: center; padding: 2rem 0;">
                                    ...
                                    <h3 style="color: var(--danger); font-weight: 700; margin-bottom: 0.75rem;">Batas Percobaan Tercapai</h3>
                                    <p style="color: var(--neutral-600); margin-bottom: 2rem;">
                                        Anda telah menggunakan semua percobaan (<?php echo e($attemptCount); ?>/<?php echo e($kursus->max_quiz_attempts); ?>) dan belum mencapai nilai minimum.
                                    </p>
                                    ...
                                    <div class="history-item">
                                        <div class="d-flex justify-content-between align-items-start" style="margin-bottom: 0.75rem;">
                                            ...
                                            <?php if($attempt->score !== null): ?>
                                                <span class="attempt-badge <?php echo e($attempt->is_passed ? 'passed' : 'failed'); ?>">
                                                    <?php echo e(number_format($attempt->score, 2)); ?>%
                                                </span>
                                            <?php else: ?>
                                        ...
                                        <div>
                                            <?php if($attempt->completed_at): ?>
                                                <a href="<?php echo e(route('courses.final-quiz.result', [$kursus->id, $attempt->id])); ?>" 
                                                   class="btn-modern btn-primary-modern" 
                                                   style="font-size: 0.875rem; padding: 0.5rem 1rem;">
                                                    <i class="fas fa-eye"></i> Lihat Detail
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('courses.final-quiz.take', [$kursus->id, $attempt->id])); ?>" 
                                                   class="btn-modern btn-primary-modern" 
                                                   style="font-size: 0.875rem; padding: 0.5rem 1rem;">
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mb-0">Apakah Anda yakin ingin memulai final quiz? Pastikan Anda siap.</p>
            </div>
        </div>
        <div class="flex justify-end gap-2">
            <button type="button" class="px-4 py-2 rounded-lg bg-gray-100 text-gray-800 font-semibold hover:bg-gray-200 transition" onclick="closeStartConfirm()">Batal</button>
            <button type="button" class="px-4 py-2 rounded-lg bg-teal-600 text-white font-semibold hover:bg-teal-700 transition" onclick="confirmStartQuiz()">
                Mulai Sekarang
            </button>
        </div>
    </div>
