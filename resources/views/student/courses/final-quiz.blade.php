                            ...
                            @if($hasPassed)
                                <div style="text-align: center; padding: 2rem 0;">
                                    ...
                                    <p style="color: var(--neutral-600); font-size: 1.125rem; margin-bottom: 2rem;">
                                        Nilai terakhir: <strong style="font-family: 'Space Mono', monospace; color: var(--success);">{{ number_format($latestAttempt->score, 2) }}%</strong>
                                    </p>
                            ...
                            @elseif($canRetake)
                                <div style="margin-bottom: 2rem;">
                                    ...
                                    <p style="color: var(--neutral-600); margin-bottom: 0;">
                                        Percobaan: <strong style="color: var(--primary);">{{ $attemptCount }}</strong> / <strong>{{ $kursus->max_quiz_attempts }}</strong>
                                    </p>
                                </div>
                            ...
                            @else
                                <div style="text-align: center; padding: 2rem 0;">
                                    ...
                                    <p style="color: var(--neutral-600); margin-bottom: 2rem;">
                                        Anda telah menggunakan semua percobaan ({{ $attemptCount }}/{{ $kursus->max_quiz_attempts }}) dan belum mencapai nilai minimum.
                                    </p>
