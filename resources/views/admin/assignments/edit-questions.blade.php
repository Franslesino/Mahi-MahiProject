...
<div class="p-8">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        <form action="{{ route('admin.assignments.add-questions', $assignment) }}" method="POST" id="addQuestionsForm">
            @csrf
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                @if($assignment->is_published)
                <form action="{{ route('admin.assignments.unpublish', $assignment) }}" method="POST">
                    @csrf
                    <button type="submit" 
                ...
                @else
                <form action="{{ route('admin.assignments.publish', $assignment) }}" method="POST">
                    @csrf
                    <button type="submit" 
