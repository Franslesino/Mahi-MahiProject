                        ...
                        <div id="importQuestionList" class="space-y-4 max-h-96 overflow-y-auto border border-gray-300 rounded-lg p-4">
                            @foreach($questionBanks as $bank)
                                @if($bank->questions->count() > 0)
                                    <div class="question-bank-group border-2 border-gray-200 rounded-xl overflow-hidden" data-bank-name="{{ strtolower($bank->name ?? $bank->title ?? '') }}">
                                        <!-- Bank Header -->
                                        <div class="bg-gradient-to-r from-emerald-50 to-teal-50 px-4 py-3 border-b border-gray-200">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h4 class="font-bold text-gray-800">{{ $bank->name ?? $bank->title }}</h4>
...
// Item #27: Pilih semua soal dari bank tertentu (Admin)
...
// Item #27: Toggle collapse bank soal (Admin)
