    ...
    <div class="bg-gray-50 min-h-screen transition-all duration-300" id="main-content">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <a href="{{ url()->previous() != url()->current() ? url()->previous() : route('home') }}"
                class="inline-flex items-center gap-2 text-gray-600 hover:text-teal-600 transition mb-6 group">
                <div
                    class="w-8 h-8 bg-white rounded-full shadow-sm flex items-center justify-center group-hover:bg-teal-50 transition">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm leading-relaxed mb-3">
                                    Kursus ini hanya dapat dibeli hingga
                                    <strong>{{ $course->purchase_deadline_date->format('d M Y H:i') }}</strong>.
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm leading-relaxed">
                                    Kursus ini dapat dibeli hingga
                                    <strong>{{ $course->purchase_deadline_date->format('d M Y H:i') }}</strong>.
                ...
                @elseif($daysLeft <= 30)
                    <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl shadow-lg p-5 mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm">
                                Pendaftaran kursus ini akan ditutup pada
                                <strong>{{ $course->purchase_deadline_date->format('d M Y') }}</strong>
                            </p>
                        </div>
                    </div>
                @endif
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden mb-6">
                <!-- Course Image -->
                @if($course->image_url)
                    <img src="{{ $course->image_url }}" alt="{{ $judul }}" class="w-full h-80 object-cover">
                @else
                    <div
                        class="w-full h-80 bg-gradient-to-br from-teal-400 via-blue-500 to-purple-600 flex items-center justify-center">
                ...
                <div class="p-8">
                    ...
                    <!-- Title -->
                    <h1 class="text-3xl font-bold text-gray-900 mb-6">{{ $judul }}</h1>
                    ...
                    @if($course->instructor)
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            @else
                                <div
                                    class="w-10 h-10 bg-gradient-to-br from-teal-500 to-teal-600 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <!-- Price & Action -->
                    <div
                        class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 p-6 bg-gray-50 rounded-xl">
                        <div>
                            @if($isEnrolled)
                            ...
                            ($material->type === 'pdf' ? 'blue' :
                                ($material->type === 'quiz' ? 'purple' : 'gray'))
                                            ...
                                            @if($material->is_preview || $isEnrolled)
                                                <button
                                                    class="px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition text-sm font-medium">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3 text-gray-700">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-teal-500 to-teal-600 rounded-lg flex items-center justify-center shadow-sm">
                                <i
                                    class="fas fa-{{ $course->access_duration_days ? 'calendar-check' : 'infinity' }} text-white"></i>
                            </div>
                            <div class="flex flex-col">
                                <span
                                    class="font-semibold">{{ $course->access_duration_days ? 'Akses ' . $course->access_duration_days . ' Hari' : 'Akses Selamanya' }}</span>
                        ...
                        <div class="flex items-center gap-3 text-gray-700">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg flex items-center justify-center shadow-sm">
                        ...
                        <div class="flex items-center gap-3 text-gray-700">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center shadow-sm">
                ...
                @if($course->instructor)
                    <div class="bg-white rounded-2xl shadow-sm p-8">
                        ...
                        <div class="flex items-start gap-4 mb-4">
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-teal-500 to-teal-600 rounded-full flex items-center justify-center flex-shrink-0">
