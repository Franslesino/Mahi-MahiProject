    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="relative overflow-hidden rounded-2xl">
                ...
                <!-- Navigation Dots -->
                <div class="carousel-dots absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-10"></div>

                <!-- Navigation Arrows -->
                @if($promoBanners->count() > 1 || $promoBanners->count() == 0)
                    <button onclick="prevSlide()"
                        class="absolute left-4 top-1/2 -translate-y-1/2 bg-pnj-teal text-white shadow-md hover:shadow-xl hover:bg-teal-700 p-2 rounded-full transition z-10">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>
                    </button>
                    <button onclick="nextSlide()"
                        class="absolute right-4 top-1/2 -translate-y-1/2 bg-pnj-teal text-white shadow-md hover:shadow-xl hover:bg-teal-700 p-2 rounded-full transition z-10">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
