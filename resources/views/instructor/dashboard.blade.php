...
<div class="p-8" data-loaded="false">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="loaded-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 col-span-4">
            <!-- Total Kursus -->
            <a href="{{ route('instructor.courses') }}" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition focus:outline-none focus:ring-2 focus:ring-blue-300 block">
            ...
            <!-- Kursus Aktif -->
            <a href="{{ route('instructor.courses') }}" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition focus:outline-none focus:ring-2 focus:ring-emerald-300 block">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <!-- Total Siswa -->
            <a href="{{ route('instructor.courses') }}" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition focus:outline-none focus:ring-2 focus:ring-purple-300 block">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <!-- Total Materi -->
            <a href="{{ route('instructor.courses') }}" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition focus:outline-none focus:ring-2 focus:ring-amber-300 block">
                <div class="flex items-center justify-between">
                    <div>
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm p-6" data-card="performance">
            ...
            @if($courseStats->isEmpty())
                <div class="text-center py-12 loaded-content">
                    ...
                    <a href="{{ route('instructor.courses') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-lg border border-blue-100 mt-4 hover:bg-blue-100 transition">
                        ...
                        <div class="flex items-center gap-4 flex-1">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center gap-4 text-sm text-gray-500">
                                    ...
                                    <span><i class="fas fa-file-alt mr-1"></i>{{ $materialsCount }} materi</span>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6" data-card="activity">
            ...
            @if($recentEnrollments->isEmpty())
                <div class="text-center py-12 loaded-content">
                    ...
                    <a href="{{ route('instructor.courses') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-700 rounded-lg border border-gray-200 mt-4 hover:bg-gray-100 transition">
                ...
                <div class="space-y-4 loaded-content">
                    ...
                    <div class="flex items-start gap-3 pb-4 border-b border-gray-100 last:border-0 hover:bg-gray-50 px-2 -mx-2 rounded-lg transition">
                        ...
                        <div class="flex flex-col items-end gap-2">
                            ...
                            <a href="{{ route('instructor.courses.show', $enrollment->kursus) }}" class="text-xs text-blue-600 hover:underline">Buka kursus</a>
                            @endif
                        </div>
                    </div>
                    @endforeach
