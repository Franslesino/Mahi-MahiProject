    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-10">
                <!-- Result Hero -->
                <div class="result-hero <?php echo e($attempt->is_passed ? 'passed' : 'failed'); ?>">
                    ...
                    <div class="score-display"><?php echo e(number_format($attempt->score, 2)); ?>%</div>
                    
                    <div class="progress-container">
                        <div class="progress-bar-custom">
                            <div class="progress-fill <?php echo e($attempt->is_passed ? 'success' : 'danger'); ?>"
                                 data-progress="<?php echo e(round($attempt->score)); ?>"
                                 style="width: 0%">
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($attempt->is_passed): ?>
                        <div class="status-alert success">
                            ...
                            <span>Nilai Anda melebihi batas minimum <strong><?php echo e($kursus->min_passing_score); ?>%</strong></span>
                        </div>
                    <?php else: ?>
                        <div class="status-alert danger">
                            <i class="fas fa-exclamation-triangle"></i>
                            <span>Nilai minimum: <strong><?php echo e($kursus->min_passing_score); ?>%</strong></span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($attempt->jawabanPeserta->count()); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($attempt->jawabanPeserta->where('nilai_tercapai', 1)->count()); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($attempt->jawabanPeserta->where('nilai_tercapai', 0)->count()); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e(number_format($attempt->score, 1)); ?>%</div>
                            ...
                            <?php $__currentLoopData = $attempt->jawabanPeserta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $jawaban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="answer-item">
                                    <div class="answer-header">
                                        <div class="answer-number <?php echo e($isCorrect ? 'correct' : 'incorrect'); ?>">
                                            <?php echo e($index + 1); ?>

                                        </div>
                                        <div style="flex: 1;">
                                            <div class="question-text"><?php echo e($question?->question_text ?? 'Pertanyaan'); ?></div>
                                            <?php if($question?->image): ?>
                                                <div class="question-image">
                                                    <img src="<?php echo e(asset('storage/' . $question->image)); ?>" alt="Question Image">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($isEssay): ?>
                                        <div class="essay-answer">
                                            ...
                                            <div class="essay-text"><?php echo e($jawaban->answer_text ?: '-'); ?></div>
                                        </div>
                                    <?php else: ?>
                                        <div style="margin-left: 68px;">
                                            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="option-review <?php echo e($optionClass); ?>">
                                                    ...
                                                    <span class="option-text"><?php echo e($option->option_text); ?></span>
                                    ...
                                    <?php if($question?->penjelasan): ?>
                                        <div class="explanation-box" style="margin-left: 68px;">
                                            ...
                                            <div><?php echo e($question->penjelasan); ?></div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="action-buttons">
                    <a href="<?php echo e(route('courses.final-quiz.show', $kursus->id)); ?>" class="btn-action primary">
                        <i class="fas fa-arrow-left"></i>
                        Kembali ke Final Quiz
                    </a>

                    <?php if($attempt->is_passed): ?>
                        <a href="<?php echo e(route('student.course.learn', $kursus->id)); ?>" class="btn-action outline">
                    ...
                    <?php if(!$attempt->is_passed): ?>
                        ...
                        <?php if($canRetake): ?>
                            <a href="<?php echo e(route('courses.final-quiz.show', $kursus->id)); ?>" class="btn-action warning">
