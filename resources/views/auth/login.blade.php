            ...
            <div class="w-full max-w-md px-6 py-10">
                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="bagusarinta@gmail.com"
                            required
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-ug hover:underline font-medium">
                            Lupa Password?
                        </a>
                    </div>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            Belum punya akun?
                            <a href="{{ route('register') }}" class="text-ug hover:underline font-medium">Daftar di
                                sini</a>
                        </p>
                    </div>
                </form>
