...
>>>>>>>> origin/sabil0:storage/framework/views/2e666892b0e340728e0bc455366fbff6.php
                                    ...
                                    <div x-show="open" 
                                        ...
                                        <div class="max-h-[70vh] sm:max-h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                            @forelse(Auth::user()->notifications()->take(15)->get() as $notification)
                                                <div class="group relative {{ $notification->isUnread() ? 'bg-blue-50 border-l-4 border-l-blue-500' : 'bg-white' }} hover:bg-gray-50 transition-colors">
                                                    <div class="p-4 flex items-start gap-3">
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <div class="flex items-start justify-between gap-2">
                                                                <p class="text-sm font-semibold text-gray-900 leading-tight">{{ $notification->title }}</p>
                                                                @if($notification->isUnread())
                                                                    <span class="flex-shrink-0 w-2 h-2 bg-blue-600 rounded-full mt-1"></span>
                                                                @endif
                                                            </div>
                                                            <p class="text-xs text-gray-600 mt-1.5 line-clamp-2 leading-relaxed">{{ $notification->message }}</p>
