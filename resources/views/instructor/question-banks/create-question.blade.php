...
<div class="p-8">
    ...
    <div x-data="{ 
        ...
        <form id="questionForm" action="{{ route('instructor.question-banks.questions.store', $questionBank) }}" method="POST">
            @csrf
    ...
    <div class="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-auto">
        ...
        <div class="p-6">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <a href="{{ route('instructor.question-banks.export-template') }}" 
            ...
            <!-- Upload Form -->
            <form action="{{ route('instructor.question-banks.import-questions', $questionBank) }}" 
                  method="POST" 
