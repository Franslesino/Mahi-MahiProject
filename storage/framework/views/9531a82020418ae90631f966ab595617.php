...
<head>
    ...
    <title><?php echo e(config('app.name', 'EDUQUEST')); ?> - Instructor</title>
...
<body class="bg-gray-50" x-data="{ sidebarOpen: true }">
    ...
    <aside 
        ...
        <div class="flex-shrink-0 p-6 border-b border-gray-200">
            ...
            <div class="flex items-center gap-3">
                <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                    <span class="text-white text-xl font-bold"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></span>
                </div>
        ...
        <nav class="flex-1 overflow-y-auto p-4 space-y-2">
            ...
            <a href="<?php echo e(route('instructor.dashboard')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('instructor.dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
            ...
            <!-- Kursus Saya -->
            <a href="<?php echo e(route('instructor.courses')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('instructor.courses*') && !request()->routeIs('instructor.courses.materials*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('instructor.question-banks.index')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('instructor.question-banks*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
            ...
            <!-- Bantuan -->
            <a href="<?php echo e(route('instructor.help')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('instructor.help') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative" x-data="{ openNotif: false }" @keydown.escape.window="openNotif=false">
                        ...
                        <div x-show="openNotif" x-transition 
                            ...
                            <div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                    <form action="<?php echo e(route('instructor.notifications.mark-all-read')); ?>" method="POST" id="notif-mark-all-form" class="hidden">
                                        <?php echo csrf_field(); ?>
    ...
    <script>
        (function() {
            ...
            const endpoint = "<?php echo e(route('instructor.notifications.poll')); ?>";
...
<?php /**PATH C:\Users\Sabil Aditia\OneDrive\mahi\Mahi-MahiProject\resources\views/layouts/instructor.blade.php ENDPATH**/ ?>