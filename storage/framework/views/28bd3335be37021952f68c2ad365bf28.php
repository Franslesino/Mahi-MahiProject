...
<div class="p-8">
    <div class="mb-6">
        <a href="<?php echo e(route('admin.vouchers.index')); ?>" class="text-gray-600 hover:text-gray-800 flex items-center gap-2 mb-4">
    ...
    <form action="<?php echo e(route('admin.vouchers.store')); ?>" method="POST" class="bg-white rounded-lg shadow-sm p-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" 
                          rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
                          placeholder="Deskripsi singkat tentang voucher ini..."><?php echo e(old('description')); ?></textarea>
            </div>
            ...
            <div>
                ...
                <select name="type" 
                    ...
                    <option value="fixed" <?php echo e(old('type') === 'fixed' ? 'selected' : ''); ?>>Nominal Tetap (Rp)</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="number" 
                       name="max_usage" 
                       value="<?php echo e(old('max_usage')); ?>"
                       min="1"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
                       placeholder="100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2" id="coursesList">
                        ...
                        <label class="flex items-center gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer border border-transparent hover:border-emerald-200">
                            <input type="checkbox" 
                                   ...
                                   <?php echo e(in_array($course->id, old('allowed_courses', [])) ? 'checked' : ''); ?>

                                   class="course-checkbox rounded text-emerald-500 focus:ring-emerald-500">
                            <span class="text-sm text-gray-700"><?php echo e($course->judul); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sabil Aditia\OneDrive\mahi\Mahi-MahiProject\resources\views/admin/vouchers/create.blade.php ENDPATH**/ ?>