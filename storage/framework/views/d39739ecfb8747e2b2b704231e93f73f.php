    ...
    <aside 
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="<?php echo e(route('home')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('home') ? 'bg-teal-50 text-teal-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
            ...
            <!-- Kursus Saya -->
            <a href="<?php echo e(route('my-courses')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('my-courses') ? 'bg-teal-50 text-teal-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('profile')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('profile') ? 'bg-teal-50 text-teal-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('terms')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition <?php echo e(request()->routeIs('terms') ? 'bg-teal-50 text-teal-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\Sabil Aditia\OneDrive\mahi\Mahi-MahiProject\resources\views/components/sidebar.blade.php ENDPATH**/ ?>