...
<div class="p-8">
    <div class="mb-6">
        <a href="{{ route('admin.courses.detail', $course) }}" class="text-blue-600 hover:text-blue-700 flex items-center gap-2">
        ...
        <form action="{{ route('admin.courses.materials.update', [$course, $material]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Biarkan kosong jika tidak ingin mengganti file. Maks 100MB</p>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="isi" rows="6"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('isi', $material->isi) }}</textarea>
                </div>
