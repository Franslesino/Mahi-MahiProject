...
<div class="p-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="<?php echo e(route('instructor.question-banks.create')); ?>" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
        <form method="GET" action="<?php echo e(route('instructor.question-banks.index')); ?>" class="flex flex-wrap gap-4">
            ...
            <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e($bank->title); ?></h3>
                            <?php if($bank->category): ?>
                            <span class="inline-block px-3 py-1 bg-blue-100 text-blue-700 text-xs rounded-full font-medium">
                                <?php echo e($bank->category); ?>

                            </span>
                            <?php endif; ?>
                        </div>
                        <?php if($bank->is_public): ?>
                    ...
                    <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e($bank->description); ?></p>
                    <?php endif; ?>

                    <div class="flex items-center gap-4 text-sm text-gray-500 mb-4">
                        <span>
                            <i class="fas fa-question-circle mr-1"></i>
                            <?php echo e($bank->questions_count); ?> soal
                        </span>
                        <span>
                            <i class="fas fa-user mr-1"></i>
                            <?php echo e($bank->creator->name); ?>

                        </span>
                    </div>

                    <div class="flex gap-2">
                        <a href="<?php echo e(route('instructor.question-banks.show', $bank)); ?>" 
                        ...
                        <?php if($bank->created_by == auth()->id()): ?>
                        <a href="<?php echo e(route('instructor.question-banks.edit', $bank)); ?>" 
                           class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-medium text-sm">
                            <i class="fas fa-edit"></i>
                        </a>
                        <form action="<?php echo e(route('instructor.question-banks.destroy', $bank)); ?>" 
                              method="POST" 
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sabil Aditia\OneDrive\mahi\Mahi-MahiProject\resources\views/instructor/question-banks/index.blade.php ENDPATH**/ ?>