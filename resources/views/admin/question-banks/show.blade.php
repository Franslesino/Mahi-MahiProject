...
<div class="p-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.question-banks.create-question', $questionBank) }}" 
               class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium">
                <i class="fas fa-plus mr-2"></i>Tambah Soal
            </a>
            <a href="{{ route('admin.question-banks.export-questions', $questionBank) }}" 
    ...
    <div x-show="showForm" x-cloak class="border-t pt-6 mb-6">
        <form action="{{ route('admin.question-banks.questions.store', $questionBank) }}" method="POST" id="questionForm">
            @csrf
