<footer class="bg-emerald-100 text-gray-700 mt-20">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-14 grid grid-cols-2 md:grid-cols-4 gap-10 text-sm">
        ...
        <div>
            <div class="mb-4">
                <a href="{{ route('home') }}" class="text-2xl font-bold hover:opacity-80 transition">
                    <span style="color: #005F56;">UpGreenius</span>
                </a>
            </div>
        ...
        <!-- Hubungi Kami -->
        <div>
            <h4 class="font-semibold text-[#005F56] mb-4">Hubungi Kami</h4>
    ...
    <div class="bg-emerald-200 text-gray-700 text-xs text-center py-4">
