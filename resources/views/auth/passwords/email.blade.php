...
<head>
    ...
    <title>Lupa Password - UpGreenius</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-lg bg-white shadow-lg rounded-2xl p-8 relative">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-semibold text-ug mb-2">Lupa Password</h1>
                <p class="text-gray-600 text-sm">Masukkan email Anda. Kami akan mengirim link reset password.</p>
            </div>
            ...
            <div class="mt-6 text-center text-sm text-gray-600">
                Sudah ingat password? <a href="{{ route('login') }}" class="text-ug hover:text-ugDark font-semibold">Masuk</a>
            </div>
        </div>
    </div>
</body>
