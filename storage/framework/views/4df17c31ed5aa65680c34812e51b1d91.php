        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="quiz-header">
                    <div class="quiz-info">
                        <h3><?php echo e($quiz->judul_quiz); ?></h3>
                        <p>Percobaan ke-<?php echo e($attempt->attempt_number); ?> • <?php echo e($questions->count()); ?> Pertanyaan</p>
                    </div>
                    <?php if($quiz->durasi_quiz): ?>
                        <div class="timer-box">
                            <i class="fas fa-clock"></i>
                            <span id="timer"><?php echo e($quiz->durasi_quiz); ?>:00</span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <form id="quizForm" onsubmit="submitQuiz(event)">
                    ...
                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="question-card" style="animation-delay: <?php echo e($index * 0.05); ?>s">
                            <div class="question-header">
                                <div class="question-number"><?php echo e($index + 1); ?></div>
                                <div class="question-content">
                                    <h4 class="question-text"><?php echo e($question->question_text); ?></h4>
                                    ...
                                    <?php $__currentLoopData = $question->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="option-item" onclick="selectOption(this)">
                                            <input class="form-check-input" 
                                                   ...
                                                   required>
                                            <label for="option_<?php echo e($question->id); ?>_<?php echo e($option->id); ?>">
...
// Timer functionality
let timeLeft = <?php echo e($quiz->durasi_quiz ?? 0); ?> * 60;
let timerInterval;
